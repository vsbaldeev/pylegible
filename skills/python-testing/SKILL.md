...
description: >
  ...
  code, or checking coverage. For the production code's own style use python-idioms; for how
  the tests/ tree is laid out relative to the source tree use python-project-structure.
---
